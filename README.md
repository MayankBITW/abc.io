...
**Website Link:** [https://test.id/](https://www.test.id/)
...
```bash
git clone https://github.com/Mayank Yadav/Portofolio_V5.git
cd Portofolio_V5
```
...
VALUES ('Created By Ekizr', 'Mayank Yadav');
...
**Mayank Yadav**
  ...
  <!-- - Website: [https://www.test.id/](https://www.test.id/) -->
  - GitHub: [Mayank Yadav](https://github.com/Mayank Yadav)
